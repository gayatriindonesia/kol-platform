...
export const personalInfoSchema = z.object({
  name: z.string().min(3, "Nama Campaign wajib diisi!"),
  // phone: z
  //  .string()
...
export const selfServiceSchema = z.object({
  platformId: z.string().min(1, "Harus memilih platform"),
  adTemplate: z.instanceof(File, {
    message: "Harus mengupload template iklan",
  }),
  scheduling: z.date().min(new Date(), "Tidak bisa memilih tanggal lampau"),
});
