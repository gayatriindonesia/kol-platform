...
import Sidebar from '@/components/kol/Sidebar'
import Header from '@/components/kol/Header'
...
export default function KolLayoutWrapper({ children, session: serverSession }: Props) {
